...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.00, d2);
            Seller s2 = new Seller(2, "Rafael Kowalski", "rafael@gmail.com", new DateTime(1997, 6, 06), 1500.00, d1);
            Seller s3 = new Seller(3, "Gustavo Viadon", "gustavo@gmail.com", new DateTime(1999, 3, 21), 5000.00, d4);
            Seller s4 = new Seller(4, "Marinho", "marinho@gmail.com", new DateTime(1985, 10, 10), 30.00, d3);
            Seller s5 = new Seller(5, "Lucas Floriani", "Lukinhasgamers@gmail.com", new DateTime(1995, 10, 15), 10000.00, d1);
            Seller s6 = new Seller(6, "Nayarao azulao", "nayara@gmail.com", new DateTime(1993, 6, 29), 2000.00, d3);
